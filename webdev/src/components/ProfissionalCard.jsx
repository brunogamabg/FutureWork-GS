...
export default function ProfessionalCard({ profissional, onClick }) {
  ...
  return (
    <div
      className="bg-white rounded-2xl shadow-md hover:shadow-xl p-6 cursor-pointer hover:scale-[1.02] transition-all border border-gray-100 flex flex-col items-center"
